...
- Sneaseler (Map ID 206, all incense) are no longer Shinyn't Pikachus
- Sneaseler (Map ID 206 [Mt. Coronet], Leaf Green [Hisui] incense) replaced accidental Gigamax. Snorlax
