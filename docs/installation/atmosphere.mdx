...
1. Set up Brilliant Diamond 1.3.0 in your emuNAND. Please use NXDumpTool to copy your personal Brilliant Diamond and update file to the SD and install into emuNAND. You will need two files by the end of it: the game *and* the update.
...
4. Open your Switch SD folder and drop just the "exefs" and "romfs" folders into atmosphere/contents/0100000011D90000/
