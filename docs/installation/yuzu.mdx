...
Back up your saves (right click on the game and click "Open Save Data Location") just in case of any potential issue. Delete the old romfs and exefs files. Follow the install instructions again with the new files.
