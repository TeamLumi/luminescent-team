...
1. Download Ryujinx instead unless you absolutely *cannot* run Ryujinx. Yuzu has incredible difficulty with running Luminescent 2.0F and many bugs that we will not be able to do much to help.
...
7. Change graphics setting to OpenGL and CPU accuracy to "accurate".
