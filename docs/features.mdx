...
- IV Hyper Training is now available outside Jubilife Trainer School as long as you have Bottle Caps or Golden Bottle Caps. No longer level-capped.
  - Graphical issue: under-100s will display as greyed out, but may still be selected as normal.
...
- Clothing can be changed at any PC.
  - Both male/female costumes are selectable, while retaining initial choice's pronouns and Rowan's Assistant.
