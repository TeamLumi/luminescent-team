...
import { PokemonSearch2 } from './PokemonSearch2';
...
export default function PokedexFeatures({ data }) {
    ...
    <Container>
      <Container>
        <Box display="flex" justifyContent="center" marginTop="16px">
          <PokemonSearch2 pokemonNames={data.pokemonNames} setPokemonDexId={setPokemonDexId} />
        </Box>
      </Container>
